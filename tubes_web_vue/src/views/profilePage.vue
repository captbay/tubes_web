            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  <img
                    :src="url + userurl + users.image_user"
                    alt="User"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      //get API from Laravel Backend
      axios
        .get("http://localhost:8000/api/users/" + id_user_temp + "")
        .then((response) => {
          //assign state posts with response data
    ...
    function update() {
      ...
      axios
        .post("http://localhost:8000/api/users/update/" + id_user_temp + "", {
          name: name,
          password: password,
          tgl_lahir: tgl_lahir,
          gender: gender,
