    ...
    <div class="bg-image">
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.6); height: 85vh;">
            <div class="d-flex justify-content-center align-items-center h-100">
                <h1 class="text-white mb-0 text-center fw-bold">Hi {{ users.name }}
                <h1 class="fw-bold">cari Band, Komika dan Pesulap Untuk Event Anda!</h1>
                </h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    sesuai dengan selera dan kebutuhan kalian...
                                </div>
                            </div>
        ...
        <div class="container bg-light">
            ...
            <div class="col-lg-10 align-self-baseline">
                ...
                <div class="d-flex">
                    <i class="bi bi-check-circle"></i>
                    <p class="body1 ms-3">
                        Pilihan Band, Komika, Pesulap terbaik dan langsung diseleksi oleh tim kami
                    </p>
                </div>
                <div class="d-flex">
                    <i class="bi bi-check-circle"></i>
                    <p class="body1 ms-3">
                        Kemudahan booking dan transaksi
                    </p>
                </div>
                <router-link :to="{ name: 'tentangKami' }" class="nav-link">
                    <button class="btn-more fw-bold">
